...
public class KeyBindings {
    ...
    public static final KeyMapping.Category CATEGORY = KeyMapping.Category.register(Identifier.fromNamespaceAndPath("freecam", "common"));

    public static final KeyMapping toggleFreeCam = new KeyMapping("key.zergatul.freecam.toggle", InputConstants.KEY_F6, CATEGORY);
