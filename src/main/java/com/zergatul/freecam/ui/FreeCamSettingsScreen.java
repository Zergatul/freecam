...
public class FreeCamSettingsScreen extends GuiScreen implements GuiPageButtonList.GuiResponder, GuiSlider.FormatHelper {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (tooltip != null) {
            List<String> lines = fontRenderer.listFormattedStringToWidth(tooltip, Math.min(width - 20, 300));
    ...
    private String getToggleText(String translationKey, boolean value) {
        return I18n.format(translationKey) + ": " + I18n.format(value ? "options.on" : "options.off");
    }
