...
public class KeyBindingsController {
    ...
    public static final KeyMapping toggleCamControl = new KeyMapping("key.zergatul.freecam.camcontrol.toggle", InputConstants.UNKNOWN.getValue(), "category.zergatul.freecam");
